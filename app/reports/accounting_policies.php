    ...
    switch ($entity) {
        case 'corporate':
            return [
                ...
                'Taxes on Income (AS 22): Tax expense comprises current tax and deferred tax. Current tax is measured based on taxable income for the year, computed in accordance with the provisions of the Income-tax Act, 1961. Deferred tax is recognised on timing differences between accounting income and taxable income, subject to the consideration of prudence.',
