...
$v2NavItems = [
    ...
    ['section' => 'fy_manager',  'icon' => '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>', 'label' => 'Financial Year Console', 'href' => $v2HasEntity ? BASE_URL . 'fy_workspace.php?entity_id=' . $v2CompanyId : '#', 'disabled' => !$v2HasEntity],
    ['section' => 'data',        'icon' => '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>', 'label' => 'Data Console', 'href' => ($v2HasEntity && $v2HasFy) ? BASE_URL . 'data/index.php?entity_id=' . $v2CompanyId . '&fy_id=' . $v2FyId : '#', 'disabled' => !($v2HasEntity && $v2HasFy)],
    ['section' => 'statements',  'icon' => '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>', 'label' => 'Financial Statement Console', 'href' => ($v2HasEntity && $v2HasFy) ? BASE_URL . 'statements/financials.php?entity_id=' . $v2CompanyId . '&fy_id=' . $v2FyId : '#', 'disabled' => !($v2HasEntity && $v2HasFy)],
    ['section' => 'review',      'icon' => '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 11l3 3L22 4"></path><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path></svg>', 'label' => 'Validation &amp; Reconcile', 'href' => ($v2HasEntity && $v2HasFy) ? BASE_URL . 'review/index.php?company_id=' . $v2CompanyId . '&fy_id=' . $v2FyId : '#', 'disabled' => !($v2HasEntity && $v2HasFy)],
