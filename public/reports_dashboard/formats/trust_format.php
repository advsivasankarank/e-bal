...
$receiptsTotal = $trustIncome;
$prevReceiptsTotal = $prevTrustIncome;
$paymentsTotal = $trustExpenditure;
$prevPaymentsTotal = $prevTrustExpenditure;
?>
...
<tr>
    ...
    <?= pvRaw('<b>' . format_inr($prevCashClose = ($prevPaymentsTotal > 0 ? $openCash + $prevReceiptsTotal - $prevPaymentsTotal : $closeCash)) . '</b>') ?>
    <td></td>
    <td class="figure"></td>
    <td<?= $isFirstYear ? '' : ' data-prev' ?>></td>
</tr>
...
<tr><td style="border:0; text-align:right;">
    <strong>For <?= htmlspecialchars($company_meta['entity_type'] ?? 'Trust') ?></strong><br><br><br><br>
    <?= htmlspecialchars($company_meta['signatory_1_name'] ?? 'Trustee') ?><br>
    <div class="signature-caption">Trustee / Authorised Signatory</div>
</td></tr>
</table>
</section>
...
<tr>
    ...
    <td class="figure"><b><?= format_inr($trustIncome) ?></b></td>
    <?= pvRaw('<b>' . format_inr($prevTrustIncome) . '</b>') ?>
    <td><b>Total Expenditure</b></td>
    <td class="figure"><b><?= format_inr($trustExpenditure) ?></b></td>
    <?= pvRaw('<b>' . format_inr($prevTrustExpenditure) . '</b>') ?>
</tr>
...
<tr>
    ...
    <td class="figure"></td>
    <td<?= $isFirstYear ? '' : ' data-prev' ?>></td>
    <td><b>Net Surplus transferred to Capital Fund</b></td>
    <td class="figure"><b><?= format_inr($netSurplus) ?></b></td>
    <?= pvRaw('<b>' . format_inr($prevNetSurplus) . '</b>') ?>
</tr>
<?php else: ?>
<tr>
    <td><b>Net Deficit transferred to Capital Fund</b></td>
        ...
        <table class="signature-table" width="100%" style="border:0; border-collapse:collapse;">
            <tr>
                <td style="width:50%; border:0; padding:0 0 0 20px; text-align:right; vertical-align:top;">
                    <strong><?= htmlspecialchars($company_meta['signatory_1_name'] ?? 'Trustee 1') ?></strong><br>
                    <?= htmlspecialchars($company_meta['signatory_1_designation'] ?? 'Trustee') ?><br>
                    <?= htmlspecialchars($company_meta['signatory_1_id_no'] ?? '') ?><br><br><br>
                    Signature
                </td>
                <td style="width:50%; border:0; padding:0 0 0 20px; text-align:right; vertical-align:top;">
                    <strong><?= htmlspecialchars($company_meta['signatory_2_name'] ?? 'Trustee 2') ?></strong><br>
                    <?= htmlspecialchars($company_meta['signatory_2_designation'] ?? 'Trustee') ?><br>
...
<tr><td colspan="<?= $prevColspan4 ?>"><b>CORPUS / CAPITAL FUND AND LIABILITIES</b></td></tr>

<tr><td><b>Capital Fund</b></td><td></td><td></td><?php if (!$isFirstYear): ?><td data-prev></td><?php endif; ?></tr>
<?php if ($corpus > 0): ?>
<tr><td>&emsp;Corpus Fund</td><td><a href="#note-capital-fund">1</a></td><td class="figure"><?= format_inr($corpus) ?></td><?= pv($prevCorpus) ?></tr>
<?php endif; ?>
...
<?php endif; ?>
<tr><td><b>Total Capital Fund</b></td><td></td><td class="figure"><b><?= format_inr($corpus + $generalFund) ?></b></td><?= pvRaw('<b>' . format_inr($prevCorpus + $prevGeneralFund) . '</b>') ?></tr>
