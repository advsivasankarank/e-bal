...
<tr><td>Changes in Inventories</td><td class="note-col"><a href="#note-24"><?= $data['note_refs']['Changes in Inventories of Finished Goods, Work-in-Progress and Stock-in-Trade'] ?? 24 ?></a></td><td class="figure"><?= format_inr($data['inventory_change']) ?></td><?= pv($data['prev_inventory_change']) ?></tr>
